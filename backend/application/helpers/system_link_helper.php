...
define('RESSOURCES_ROLEPERM_PERMISSION_URL',site_url('ressources/roleperms/permission_by/name/%QUERY%/'));
define('RESSOURCES_ROLEPERM_ADD_PERM_TO_ROLE_URL',site_url('ressources/roleperms/async_addpermtorole/format/json'));
//ressources/Roleperms/permission_by/name/user/tk/0B57A11CC148472/format/json