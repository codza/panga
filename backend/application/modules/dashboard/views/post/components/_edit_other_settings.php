...
<div class="form-group">
    ...
    <label class="col-md-1 radio-inline"><input type="radio" name="optradio">Sequential</label>
    <label class="col-md-1 radio-inline"><input type="radio" name="optradio">Date</label>
</div>
<div class="form-group" >
