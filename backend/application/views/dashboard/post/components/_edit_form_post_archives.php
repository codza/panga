...
<?php echo form_open(current_url(),$attributes);?>
    ...
    <div class="form-group" >
        ...
        <div class="col-md-4">
            ...
            <?php echo form_dropdown('posttemplate', array('overview_page' => 'Pages Overview', 'primary_page' => 'Primary page', 'secondary_post' => 'Secondary Posts', 'welcome_page' => 'Welcome Page'),$post->post_template,$attr ); ?>
        </div>
    </div>
    <div class="form-group" >
...
<?php echo form_open_multipart('admin/posts/upload_media');?>
